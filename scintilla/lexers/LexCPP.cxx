...
const char *const cppWordLists[] = {
	...
	"Preprocessor definitions (C/C++) or typedefs (Java)",
...
Sci_Position SCI_METHOD LexerCPP::WordListSet(int n, const char *wl) {
	...
	case 2:
		...
		break;
	case 3:
		wordListN = &stdClasses;	// Global classes and typedefs
		break;
	case 4:
		wordListN = &ppDefinitions;	// Preprocessor definitions (C/C++) or typedefs (Java)
		break;
	case 5:
