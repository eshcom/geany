...
static const HLStyle highlighting_styles_C[] =
{
	...
	{ SCE_C_ADD_FUNC,				"add_func",					FALSE },
	{ SCE_C_STD_MACRO,				"std_macro",				FALSE },
	{ SCE_C_ADD_MACRO,				"add_macro",				FALSE },
	/* used for local structs and typedefs */
	{ SCE_C_GLB_CLASS,				"glb_class",				FALSE },
	{ SCE_C_ADD_CLASS,				"add_class",				FALSE },
	{ SCE_C_IDENTIFIER,				"identifier",				FALSE },
	{ SCE_C_CPP_TYPE,				"cpp_type",					FALSE },
	{ SCE_C_FUNCTION,				"function",					FALSE },
	{ SCE_C_MACRO,					"macro",					FALSE },
	{ SCE_C_PREPROC,				"preproc",					FALSE },
	...
	{ SCE_C_ESCAPESEQ,				"escapeseq",				FALSE },
	{ SCE_C_FORMATSEQ,				"formatseq",				FALSE },
	{ SCE_C_USERLITERAL,			"userliteral",				FALSE },
	{ SCE_C_UUID,					"uuid",						FALSE },
	{ SCE_C_REGEX,					"regex",					FALSE },
	{ SCE_C_VERBATIM,				"verbatim",					FALSE },
	{ SCE_C_TRIPLEVERBATIM,			"tripleverbatim",			FALSE },
	{ SCE_C_JSONKEYSTRING,			"jsonkeystring",			FALSE },
	...
	{ SCE_C_PREPROCCOMMENT,			"preproccomment",			FALSE },
	{ SCE_C_PREPROCCOMMENTDOC,		"preproccommentdoc",		FALSE }
};
...
static const HLStyle highlighting_styles_CSS[] =
{
	...
	{ SCE_CSS_HEX_COLOR,				"hex_color",				FALSE },
	{ SCE_CSS_ERR_VALUE,				"error_value",				FALSE },
...
static const HLStyle highlighting_styles_ELIXIR[] =
{
	...
	{ SCE_ELIXIR_STRING_EEXOPER,	"string_eexoper",	FALSE },
...
static const HLStyle highlighting_styles_ERLANG[] =
{
	...
	{ SCE_ERLANG_STD_WORD,			"std_word",				FALSE },
	{ SCE_ERLANG_STD_ATOM,			"std_atom",				FALSE },
	{ SCE_ERLANG_STD_FUNC,			"std_func",				FALSE },
	{ SCE_ERLANG_STD_MODULE,		"std_module",			FALSE },
	{ SCE_ERLANG_STD_MODULE_ATTR,	"std_module_attr",		FALSE },
	{ SCE_ERLANG_STD_MACRO,			"std_macro",			FALSE },
	{ SCE_ERLANG_TYPE_FUNC,			"type_func",			FALSE },
	...
	{ SCE_ERLANG_FUNCTION,			"function",				FALSE },
	{ SCE_ERLANG_MODULE,			"module",				FALSE },
	{ SCE_ERLANG_MODULE_ATTR,		"module_attr",			FALSE },
	{ SCE_ERLANG_ATOM,				"atom",					FALSE },
	{ SCE_ERLANG_NODE,				"node",					FALSE },
	...
	{ SCE_ERLANG_ESCAPESEQ,			"escapeseq",			FALSE },
	{ SCE_ERLANG_FORMATSEQ,			"formatseq",			FALSE },
	...
	{ SCE_ERLANG_COMMENT_TAG,		"comment_tag",			FALSE },
	{ SCE_ERLANG_COMMENT_MACRO_TAG,	"comment_macro_tag",	FALSE }
};
static const HLKeyword highlighting_keywords_ERLANG[] =
{
	...
	{ 2, "std_funcs",			FALSE },
	{ 3, "std_modules",			FALSE },
	{ 4, "std_module_attrs",	FALSE },
	{ 5, "std_macros",			FALSE },
	{ 6, "type_funcs",			FALSE },
	{ 7, "preproc",				FALSE },
	{ 8, "comment_tags",		FALSE },
	{ 9, "comment_macro_tags",	FALSE }
};
...
static const HLStyle highlighting_styles_PYTHON[] =
{
	...
	{ SCE_P_STD_WORD,			"std_word",			FALSE },
	{ SCE_P_ADD_WORD,			"add_word",			FALSE },
	...
	{ SCE_P_DEFCLASS,			"defclass",			FALSE },
	{ SCE_P_DEFFUNC,			"deffunc",			FALSE },
	...
	{ SCE_P_STRINGTRIPLE,		"stringtriple",		FALSE },
	{ SCE_P_CHARSTR,			"charstr",			FALSE },
	{ SCE_P_CHARSTRTRIPLE,		"charstrtriple",	FALSE },
	{ SCE_P_STRINGEOL,			"stringeol",		FALSE },
	{ SCE_P_ESCAPESEQ,			"escapeseq",		FALSE },
	{ SCE_P_FORMATSEQ,			"formatseq",		FALSE },
	{ SCE_P_FSTRING,			"fstring",			FALSE },
	{ SCE_P_FSTRINGTRIPLE,		"fstringtriple",	FALSE },
	{ SCE_P_FCHARSTR,			"fcharstr",			FALSE },
	{ SCE_P_FCHARSTRTRIPLE,		"fcharstrtriple",	FALSE },
