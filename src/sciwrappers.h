...
gint		sci_find_text				(ScintillaObject *sci, gint flags,
										 struct Sci_TextToFind *ttf);
void		sci_set_font				(ScintillaObject *sci, gint style,
...
gint		sci_replace_target			(ScintillaObject *sci, const gchar *text,
										 gboolean regex);
...
void		sci_set_selection			(ScintillaObject *sci, gint anchorPos,
										 gint currentPos);

gint		sci_get_position_from_xy	(ScintillaObject *sci, gint x, gint y,
										 gboolean nearby);
...
gint		sci_search_next				(ScintillaObject *sci, gint flags,
										 const gchar *text);
gint		sci_search_prev				(ScintillaObject *sci, gint flags,
										 const gchar *text);
...
void		sci_set_keywords			(ScintillaObject *sci, guint k,
										 const gchar *text);
