...
static void save_dialog_prefs(GKeyFile *config)
{
	...
	g_key_file_set_boolean(config, PACKAGE, "pref_main_confirm_project_closure", project_prefs.confirm_project_closure);
	...
	/* interface */
	g_key_file_set_boolean(config, PACKAGE, "sidebar_symbols_visible", interface_prefs.sidebar_symbols_visible);
...
static void load_dialog_prefs(GKeyFile *config)
{
	...
	project_prefs.confirm_project_closure = utils_get_setting_boolean(config, PACKAGE, "pref_main_confirm_project_closure", FALSE);
	...
	interface_prefs.sidebar_symbols_visible = utils_get_setting_boolean(config, PACKAGE, "sidebar_symbols_visible", TRUE);
